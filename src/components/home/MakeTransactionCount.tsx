...
export default function MakeTransactionCount() {
    ...
    return (
        <section className="relative bg-background md:py-20 py-10">
            ...
            <div className="max-w-7xl mx-auto md:mt-10 mt-5 text-center">
                <h1 className="text-[40px] font-ppmori-semibold text-foreground">
            ...
            <div className="mx-auto max-w-5xl flex flex-col items-center justify-center w-full px-4 sm:px-6 lg:px-10 mt-20">
                <div className="flex gap-4 flex-wrap justify-center">
                    {chips.map((chip, index) => (
                        <div key={index} className="bg-white border min-w-[277px] border-[#ACACAC] rounded-full pl-1 pr-4 py-1 flex items-center gap-2">
                            <div className="p-1 md:w-[50px] md:h-[50px] w-2 h-2 rounded-full bg-head flex justify-center items-center">
                            ...
                            <div className="md:text-[18px] text-[12px] font-ppmori text-foreground">
                                {chip}
                            </div>
                        </div>
                    ))}
                </div>
                <div className="w-[80%] h-full md:w-58.75 md:h-auto aspect-[0.79] flex justify-center items-center my-10 relative">
