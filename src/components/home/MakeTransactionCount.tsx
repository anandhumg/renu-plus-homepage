...
export default function MakeTransactionCount() {
    ...
    return (
        <section className="relative bg-background md:py-20 py-15">
            ...
            <div className="mx-auto max-w-5xl flex flex-col items-center justify-center w-full px-4 sm:px-6 lg:px-10 md:mt-20 mt-5">
                <div className="flex gap-4 flex-wrap justify-center">
                    {chips.map((chip, index) => (
                        <div key={index} className="bg-white border min-w-[277px] md:w-fit w-full border-[#ACACAC] rounded-full pl-1 pr-4 py-1 flex items-center gap-2">
                ...
                <div className="w-[204px] h-full md:w-58.75 md:h-auto aspect-[0.79] flex justify-center items-center my-10 relative">
