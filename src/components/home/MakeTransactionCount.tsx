        ...
        <section>
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 mt-20">
                <div className="text-center">
                    <h2 className="text-head lg:text-[40px] text-[30px] mb-20">Make Every Transaction Count</h2>
                    <div className="flex lg:flex-row flex-col justify-between items-center gap-10">
                        <div className="text-center flex flex-col items-center">
                            <div className="w-[180px] h-[180px] p-4 border border-primary border-dashed  rounded-full">
                            ...
                            <div className="font-kaisei font-medium text-black text-2xl mt-4">
                                Instant Savings
                            </div>
                            <div className="font-lato text-black text-lg mt-4">
                                Boost daily budgets
                            </div>
                        </div>
                        <div className="text-center flex flex-col items-center">
                            ...
                            <div className="font-kaisei text-black font-medium text-2xl mt-4">
                                Smart Discounts
                            </div>
                            <div className="font-lato text-black text-lg mt-4">
