        ...
        <section className="bg-white md:py-20 py-10">
            <div className="mx-auto max-w-5xl flex flex-col items-center justify-center w-full px-4 sm:px-6 lg:px-10 mt-20">
                <div className="text-center w-full">
                    <h2 className="text-foreground font-ppmori-semibold md:text-[40px] text-[30px] md:mb-20 mb-10">Make every transaction <span className="text-head">count</span></h2>
                    <div className="flex lg:flex-row flex-col justify-between items-center gap-10">
                        <div className="text-center flex flex-col items-center">
                            <div className="w-40 h-40 p-4 border border-primary border-dashed  rounded-full">
