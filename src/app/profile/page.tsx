...
export default function ProfilePage() {
    ...
    const renderRenuTab = (isMobile: boolean = false) => (
        <motion.div
            key="renu-tab"
            initial={{ opacity: 0, y: 10 }}
            animate={{ opacity: 1, y: 0 }}
                        ...
                        {!isMobileDetailOpen ? (
                            ...
                            >
                                <div className="divide-y divide-gray-100 bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                                    ...
                                    >
                                        <div className="flex items-center gap-4">
                                            <div className="w-10 h-10 rounded-full bg-[#F7F4EB] text-[#7C5D48] flex items-center justify-center shrink-0">
                                                <UserIcon size={18} />
                                            </div>
                                            <div>
                                                <h3 className="font-ppmori-semibold text-base text-gray-950">Profile</h3>
                                                <p className="text-xs text-gray-500 mt-0.5">Manage your personal information and details</p>
                                            </div>
                                        </div>
                                    ...
                                    >
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                <h3 className="font-ppmori-semibold text-base text-gray-950">Renu+ Subscription</h3>
                                                <p className="text-xs text-gray-500 mt-0.5">View your membership status, perks, and card</p>
                                            </div>
                                        </div>
                                        <ChevronRight size={18} className="text-gray-400" />
                                    </button>
                                ...
                                <div className="pt-2">
                                    ...
                                    >
                                        <div className="flex items-center gap-4">
                                            <div className="w-10 h-10 rounded-full bg-[#FED7D7] text-[#E53E3E] flex items-center justify-center shrink-0">
                                                <LogOut size={18} />
                                            </div>
                                            <div>
                                                <h3 className="font-ppmori-semibold text-base">Sign Out</h3>
                                                <p className="text-xs text-[#E53E3E]/75 mt-0.5">Sign out of your Renu+ account</p>
                                            </div>
                                        </div>
                            ...
                            >
                                ...
                                {/* Active Tab Content */}
                                {activeTab === 'profile' && renderProfileTab()}
                                {activeTab === 'renu' && renderRenuTab(true)}
                                {activeTab === 'help' && renderHelpTab()}
                            </motion.div>
                        )}
                    </AnimatePresence>
