                        ...
                        <div className="flex flex-col divide-y divide-gray-200">
                            ...
                            <div className="flex items-start gap-4 py-6">
                                <div className="border border-dashed border-primary rounded-full p-1.5 shrink-0">
                                    <div className="bg-[#F9F6F4] rounded-full md:w-10 w-8 md:h-10 h-8 flex items-center justify-center">
                                        {/* Link/chain icon */}
                                ...
                                <div className="border border-dashed border-primary rounded-full p-1.5 shrink-0">
                                    <div className="bg-[#F9F6F4] rounded-full md:w-10 w-8 md:h-10 h-8 flex items-center justify-center">
                                        ...
                                        <svg width="20" height="18" viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M1 4C1 3.20435 1.31607 2.44129 1.87868 1.87868C2.44129 1.31607 3.20435 1 4 1H16C16.7956 1 17.5587 1.31607 18.1213 1.87868C18.6839 2.44129 19 3.20435 19 4V14C19 14.7956 18.6839 15.5587 18.1213 16.1213C17.5587 16.6839 16.7956 17 16 17H4C3.20435 17 2.44129 16.6839 1.87868 16.1213C1.31607 15.5587 1 14.7956 1 14V4Z" stroke="#7C5D48" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                            <path d="M13 5H15M13 9H15M5 13H15M5 7C5 7.53043 5.21071 8.03914 5.58579 8.41421C5.96086 8.78929 6.46957 9 7 9C7.53043 9 8.03914 8.78929 8.41421 8.41421C8.78929 8.03914 9 7.53043 9 7C9 6.46957 8.78929 5.96086 8.41421 5.58579C8.03914 5.21071 7.53043 5 7 5C6.46957 5 5.96086 5.21071 5.58579 5.58579C5.21071 5.96086 5 6.46957 5 7Z" stroke="#7C5D48" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                </div>
                                <div>
