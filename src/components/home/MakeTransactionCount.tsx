            ...
            <div className="mx-auto max-w-5xl flex flex-col items-center justify-center w-full px-4 sm:px-6 lg:px-10 md:mt-20 mt-15">
                <div className="flex gap-4 flex-wrap justify-center">
                    {chips.map((chip, index) => (
                        <div key={index} className="bg-white border min-w-69.25 md:w-fit w-[94%] border-[#ACACAC] rounded-full pl-1 pr-4 py-1 flex items-center gap-2">
                            <div className="p-1 w-12.5 h-12.5 rounded-full bg-head flex justify-center items-center">
                ...
                <div className="w-51 h-full md:w-58.75 md:h-auto aspect-[0.79] flex justify-center items-center md:mt-10 mt-10 md:mb-10 mb-0 relative">
                    <Image src={SaveUptoImage} alt="Save up to examples with Renu Plus" fill className="object-contain" />
                </div>
            </div>
        </section>
    );
